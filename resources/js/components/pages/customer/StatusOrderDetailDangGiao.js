...
class StatusOrderDetailDangGiao extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div className="stepper">
                ...
                <div className="stepper__line">
                    ...
                    <div className="stepper__line-foreground" style={{width: 'calc((100% - 600px) * 1)', background: 'rgb(' + 45 + ',' + 194 + ',' + 88 + ')'}}>
                    </div>
                </div>
            </div>
        );
...
export default StatusOrderDetailDangGiao;